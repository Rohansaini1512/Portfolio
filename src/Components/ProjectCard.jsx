...
const ProjectCard = ({ imgSrc, imgAlt, repoURL, name, description, topics }) => {
  ...
  return (
    ...
    >
      ...
      {isHover && (
        <div
          className="absolute w-full h-full bg-[#727C57] opacity-90 transition duration-500"
          onMouseLeave={handleHover}
        >
          <p className="font-sourceSans text-[#fefffa] text-xl font-bold underline absolute bottom-4 left-4">
            <a href={repoURL} className="flex flex-row items-center gap-2" target="_blank">
